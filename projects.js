...
function displayInfo (whichOne){
    var displayText;
    if(whichOne===1){
        displayText = "<h3>Summer Intern</h3>Brokee website on accident, so I spent the majority of my time fixing it and implementing website testing frameworks. Worked on other projects as well <h5>HTML, JS, CSS, Python, InfluxDB, Mocha+Chai</h5>"
    }
    if(whichOne===2){
    ...
    if(whichOne===3){
        displayText = "<h3>Human-Computer Interaction</h3> Message me for design portfolio! Creating inclusive and intuitive projects and systems is extremely important to me<h5>Adobe Xd, Figma, Sketch</h5>"
    }
    if(whichOne===4){
