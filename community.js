...
function displayInfo (whichOne){
    ...
    if(whichOne===4){
        displayText = "<h3>National Team Member</h3>Worked with the YMCA on a national level to answer one question: How can we empower the youth through the YMCA? Implementing fall 2020!"
    }
    if(whichOne===5){
        displayText = "<h3>Team Member</h3>Collaborated with LaunchCode to try and solve their large droupout rates. Restructured TAing system and created program reentry process"
    }
    if(whichOne===6){
